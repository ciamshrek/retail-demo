...
const DB_NAME = 'Username-Password-Authentication';
...
const SKYFIRE_JWKS_URL = 'https://app-qa.skyfire.xyz/.well-known/jwks.json';

// The expected 'iss' (issuer) claim for all Skyfire JWTs.
const SKYFIRE_JWT_ISSUER = 'https://app-qa.skyfire.xyz';
...
exports.onExecuteCustomTokenExchange = async (event, api) => {
    ...
    async function validateToken(subjectToken) {
        try {
            ...
            if (payload.env !== 'qa') {
                const message = 'Token is not from qa environment.';
                console.log(
